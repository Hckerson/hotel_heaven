      ...
      >
        <div className="w-full mx-auto relative max-h-screen">
          ...
          <div className="absolute w-full mx-auto top-[45%] flex text-amber-400 justify-center flex-col items-center">
            ...
            <Link
              href={`/booking`}
              className="py-3 px-5 mt-5 text-stone-400  bg-black rounded-2xl text-lg"
            >
              Book Now
            </Link>
          </div>
        ...
        <div className="box-border  relative h-[580px] ">
          <div className="absolute inset-0 bg-[url(/svgs/trc-pattern.svg)] bg-cover bg-center opacity-20" />
          <div className="flex relative z-10 items-center w-full h-full justify-center gap-[64px]">
            <p className="flex-1 italic pl-16 pr-4 text-center">
              ...
              velit tempus, dictum massa a, lacinia quam. Nunc aliquam justo
              odio, et fringilla nunc auctor ut. Donec dapibus facilisis nunc a
              pretium. Nam nulla justo, ornare et laoreet non, rhoncus molestie
              massa. Duis vitae molestie elit. Quisque eget pretium mauris.
              Etiam at lobortis nulla, ut viverra quam. Vivamus nunc turpis,
              placerat vitae pellentesque et, varius at dolor. Donec eu dui sit
              amet urna iaculis vulputate. Pellentesque luctus, nunc in
              fermentum feugiat, diam ipsum suscipit dolor, sit amet commodo
              felis nunc non turpis. Praesent id porttitor nisl, in mollis ex.
              Maecenas ut vestibulum nisi. Nullam scelerisque consequat nibh in
              ultricies.
            </p>
        ...
        <div className="box-border  relative h-[580px] ">
          <div className="absolute inset-0 bg-[url(/svgsenter opacity-20" />
          <div className="flex  relative z-10 items-center w-full h-full justify-center gap-[64px]">
            <p className="flex-1 italic pl-16 pr-4 text-center">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam in
              velit tempus, dictum massa a, lacinia quam. Nunc aliquam justo
              ...
              massa. Duis vitae molestie elit. Quisque eget pretium mauris.
              Etiam at lobortis nulla, ut viverra quam. Vivamus nunc turpis,
              placerat vitae pellentesque et, varius at dolor.
            </p>
            <div className="flex-1 ">
              <div className="flex items-center">
                <Image
                  src={`/imgs/bed-single.jpg`}
                  alt="room"
                  className="rounded-4xl"
                  width={300}
                  height={450}
